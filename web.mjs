...
(function ($) {
    class $vtb_office extends $mol_stack {
        ...
        Logo() {
            const obj = new this.$.$mol_image();
            obj.uri = () => "vtb/logo/logo.png";
            return obj;
        }
        title() {
            return "Ближайший банк там, где ты!";
        }
        Title() {
            const obj = new this.$.$mol_view();
            obj.sub = () => [
    ...
    __decorate([
        $mol_mem
    ], $vtb_office.prototype, "Title", null);
    __decorate([
        $mol_mem
        ...
        class $vtb_office extends $.$vtb_office {
            ...
            locate() {
                ...
                if (!this.geo_accuracy())
                    return;
                this.Map().geo_jump(new $mol_vector_2d(this.geo_longitude(), this.geo_latitude()), 8 * 40075000 / this.geo_accuracy());
            }
        }
        __decorate([
            $mol_mem
